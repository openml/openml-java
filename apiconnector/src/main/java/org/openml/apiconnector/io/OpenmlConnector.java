...
public class OpenmlConnector implements Serializable {
	...
	/**
	 * Sets crendetial and automatically connect to the service using provided
	 * credentials
	 * 
	 * @param username
	 * @param password
	 ...
	 * 
	 * @return Authenticate - An object containing the Api Session Hash (which
	 *         can be used to authenticate without username / password)
	 * @throws Exception
	...
	public LicencesList dataLicences() throws Exception {
	...
	public DataFeature dataFeatures(int did) throws Exception {
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.data.features", "&data_id=" + did, sessionHash,
				verboseLevel);
	...
	public DataQuality dataQualities(int did) throws Exception {
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.data.qualities", "&data_id=" + did, sessionHash,
				verboseLevel);
	...
	/**
	 * Retrieves the qualities (meta-features) of a specified data set on a
	 * specified interval.
	 * 
	 * @param did
	 *            - The data_id of the data features to download.
	 * @param interval_start
	 *            - Constraint on where the interval should start. Null if no
	 *            constraints
	 * @param interval_end
	 *            - Constraint on where the interval should end. Null if no
	 *            constraints
	 * @param interval_size
	 *            - Constraint on where interval sizes. Null if no constraints
	 * @return DataFeatures - An object containing the qualities of the data
	 * @throws Exception
	 *             - Can be: API Error (see documentation at openml.org), server
	 *             down, etc.
	 */
	public DataQuality dataQualities(Integer did, Integer interval_start, Integer interval_end, Integer interval_size)
			throws Exception {
		String queryString = "&data_id=" + did;
		if (interval_start != null) {
			queryString += "&interval_start=" + interval_start;
		}
		if (interval_end != null) {
			queryString += "&interval_end=" + interval_end;
		}
		if (interval_size != null) {
			queryString += "&interval_size=" + interval_size;
		}

		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.data.qualities", queryString, sessionHash,
				verboseLevel);
	...
	public DataDelete dataDelete(int id) throws Exception {
		MultipartEntity params = new MultipartEntity();
		params.addPart("data_id", new StringBody("" + id));

		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.data.delete", "", params, sessionHash,
				verboseLevel);
	...
	public DataFeatureUpload dataFeaturesUpload(File description) throws Exception {
		...
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.data.features.upload", "", params, sessionHash,
				verboseLevel);
	...
	public DataQualityUpload dataQualitiesUpload(File description) throws Exception {
		...
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.data.qualities.upload", "", params, sessionHash,
				verboseLevel);
	...
	public DataQualityList dataQualitiesList() throws Exception {
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.data.qualities.list", "", sessionHash,
				verboseLevel);
	 ...
	 *            - Numeric ID of the implementation to be obtained.
	 * @return Implementation - An object containing the description of the
	 *         implementation
	 * @throws Exception
	 *             - Can be: API Error (see documentation at openml.org), server
	 *             down, etc.
	 */
	public Implementation implementationGet(int implementation_id) throws Exception {
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.implementation.get", "&implementation_id="
				+ implementation_id, sessionHash, verboseLevel);
	...
	public ImplementationTag implementationTag(int id, String tag) throws Exception {
		String qs = "&implementation_id=" + id + "&tag=" + tag;
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.implementation.tag", qs, sessionHash,
				verboseLevel);
	 ...
	 *             down, etc.
	 */
	public ImplementationOwned implementationOwned() throws Exception {
		MultipartEntity params = new MultipartEntity();

		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.implementation.owned", "", params, sessionHash,
				verboseLevel);
	 ...
	 *             down, etc.
	 */
	public ImplementationDelete implementationDelete(int id) throws Exception {
		MultipartEntity params = new MultipartEntity();
		params.addPart("implementation_id", new StringBody("" + id));

		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.implementation.delete", "", params, sessionHash,
				verboseLevel);
	...
	public ImplementationExists implementationExists(String name, String external_version) throws Exception {
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.implementation.exists", "&name=" + name
				+ "&external_version=" + external_version, sessionHash, verboseLevel);
	 ...
	 * @throws Exception
	 */
	public Tasks tasks(int task_type_id) throws Exception {
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.tasks", "&task_type_id=" + task_type_id,
				sessionHash, verboseLevel);
	...
	public TaskEvaluations taskEvaluations(int task_id) throws Exception {
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.task.evaluations", "&task_id=" + task_id,
				sessionHash, verboseLevel);
	...
	public TaskEvaluations taskEvaluations(Integer task_id, Integer interval_start, Integer interval_end,
			Integer interval_size) throws Exception {
		...
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.task.evaluations", queryString, sessionHash,
				verboseLevel);
		if (apiResult instanceof TaskEvaluations) {
			return (TaskEvaluations) apiResult;
		} else {
	...
	/**
	 * @param description
	 *            - An XML file describing the data. See documentation at
	 *            openml.org
	 * @param dataset
	...
	public UploadDataSet dataUpload(File description, File dataset) throws Exception {
		...
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.data.upload", "", params, sessionHash,
				verboseLevel);
	 ...
	 * @param description
	 *            - An XML file describing the data. See documentation at
	 *            openml.org. Should contain the url field.
	 * @return UploadDataSet - An object containing information on the data
	 *         upload.
	 * @throws Exception
	 *             - Can be: API Error (see documentation at openml.org), server
	 *             down, etc.
	 */
	public UploadDataSet dataUpload(File description) throws Exception {
		return dataUpload(description, null);
	}
	 ...
	 *             down, etc.
	 */
	public UploadImplementation implementationUpload(File description, File binary, File source) throws Exception {
		MultipartEntity params = new MultipartEntity();
		params.addPart("description", new FileBody(description));
		if (source != null)
		...
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.implementation.upload", "", params, sessionHash,
				verboseLevel);
	...
	public UploadRun runUpload(File description, Map<String, File> output_files) throws Exception {
		...
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.run.upload", "", params, sessionHash,
				verboseLevel);
	...
	public RunEvaluate runEvaluate(File description) throws Exception {
		...
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.run.evaluate", "", params, sessionHash,
				verboseLevel);
	...
	public Run runGet(int runId) throws Exception {
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.run.get", "&run_id=" + runId, sessionHash,
				verboseLevel);
	...
	public RunDelete runDelete(int id) throws Exception {
		...
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.run.delete", "", params, sessionHash,
				verboseLevel);
	...
	public RunReset runReset(int run_id) throws Exception {
		...
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.run.reset", "", params, sessionHash,
				verboseLevel);
	...
	public FileUpload fileUpload(File file) throws Exception {
		...
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.file.upload", "", params, sessionHash,
				verboseLevel);
	...
	public Job jobGet(String workbench, String task_type_id) throws Exception {
		Object apiResult = HttpConnector.doApiRequest(API_URL, "openml.job.get", "&workbench=" + workbench
				+ "&task_type_id=" + task_type_id, sessionHash, verboseLevel);
